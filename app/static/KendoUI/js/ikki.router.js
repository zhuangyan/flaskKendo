...
router.route('(/:lv1)(/:lv2)(/:lv3)(/:lv4)(/:lv5)', function(lv1, lv2, lv3, lv4, lv5, params) {
    var lvs = [lv1, lv2, lv3, lv4, lv5],
        routePath = webType + '/static/views',
        routeFile = '';
...
function refresh() {
    $('#loading').show();
    var path = "/static/views" + location.hash.split('#')[1];
    $.get(path+ '.html', function(temp) {
        $('#template').html(temp);
